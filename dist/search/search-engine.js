...
import { reciprocalRankFusion, applyBoosts, applyFilters, } from "./result-ranker.js";
export class SearchEngine {
     ...
     */
    searchSolutions(errorOrProblem, technology) {
        ...
        return results
            ...
            const hasSolutionIndicator = solutionWords.some((w) => textLower.includes(w));
            return {
                ...r,
