...
export const searchHistoryTool = {
    name: "search_history",
    description: "Search past Claude Code conversations. Supports filter syntax: project:name, before:date, after:date, tool:name. Dates can be relative (7d, 30d, 1w) or ISO (2024-01-15).",
    inputSchema: {
        type: "object",
        properties: {
            query: {
                type: "string",
                description: "Search query. Can include filters like project:myapp before:7d",
            },
            project: {
                type: "string",
...
export function handleSearchHistory(engine, args) {
    ...
    for (const r of results) {
        ...
        const date = r.timestamp
            ...
            : "unknown date";
        const toolInfo = r.toolNames.length > 0 ? ` [tools: ${r.toolNames.join(", ")}]` : "";
