...
import type { CommunityPattern } from '../federation/privacy-filter.js';
...
function formatPattern(p: CommunityPattern): FormattedPattern {
  return {
    type: p.type,
    category: p.category,
    platform: p.platform,
...
export const searchCommunityKnowledgeTool = {
  ...
  description:
    'Search the federated community knowledge hub for anonymised patterns, solutions, and error fixes ' +
 ...
 */
export async function executeSearchCommunityKnowledge(
